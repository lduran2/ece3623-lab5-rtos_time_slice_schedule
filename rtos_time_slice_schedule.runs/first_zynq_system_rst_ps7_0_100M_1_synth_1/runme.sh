...
HD_PWD='C:/Zynq_Book/first_zynq_design/first_zynq_design.runs/first_zynq_system_rst_ps7_0_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_zynq_system_rst_ps7_0_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_zynq_system_rst_ps7_0_100M_1.tcl
